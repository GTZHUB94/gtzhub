...
-- Executa o script principal em paralelo.
-- Isto permite que o watcher continue ativo mesmo que o script principal
-- tenha um loop permanente.
task.spawn(function()
...
-- Dá tempo para o script principal criar os hooks remotos.
task.wait(0.5)
